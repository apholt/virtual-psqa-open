...
def generate_MCsquare_config(WorkDir, NumberOfPrimaries, Scanner_folder, BDL_file, CT_file="CT.mhd", Plan_file="PlanPencil.txt",AnalyzeIndividualFields = False):
  print(AnalyzeIndividualFields)
  ...
  config["Export_Beam_dose"] = AnalyzeIndividualFields
  config["Dose_to_Water_conversion"] = "OnlineSPR"#"Disabled"
  config["Dose_Segmentation"] = False #Trying to get rid of empty air dose spots 7/6/26
